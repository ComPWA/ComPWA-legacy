...
Include dependency graph for GArgumentParser.hpp:\nopagebreak
\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[width=400pt]{df/d6f/GArgumentParser_8hpp__incl}
\end{center}
\end{figure}
...
\begin{center}
\leavevmode
\includegraphics[width=400pt]{db/dc3/GArgumentParser_8hpp__dep__incl}
\end{center}
\end{figure}
