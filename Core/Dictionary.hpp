...
struct dataInfo {
  ...
  dataInfo(std::string inN, std::shared_ptr<DataReader::Data> inD,
...
public:
  ...
  */
   ...
   * \sa std::string introduce(std::shared_ptr<Amplitude> inAmp, std::string
   * inName="");
  */
  virtual std::string introduce(std::shared_ptr<DataReader::Data> inData,
                                std::string inName = "");
