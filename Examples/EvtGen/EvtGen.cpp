...
int main(int argc, char **argv) {
  ...
  ComPWA::Tools::generatePhsp(10000000, gen, phspSample);
  ...
  //  intens->addResonance("TestBW", resoParameter[i][0], resoParameter[i][1], resoParameter[i][2], subsys);
  //}
  ...
  ComPWA::Tools::generate(1000000, kin, gen, intens, sample, phspSample, phspSample);
  LOG(INFO) << "EvtGenDalitz events generated";

  std::shared_ptr<Data> sampleB(new Data());
  ComPWA::Tools::generate(1000000, kinB, gen, intensB, sampleB, phspSample, phspSample);
  LOG(INFO) << "EvtGenDalitz events generated";
...
//  pl.setData(sample);
 ...
 // pl.plot();
  ...
  std::shared_ptr<Data> sampleFit(new Data());
  ComPWA::Tools::generate(1000000, kin, gen, intens, sampleFit, phspSample, phspSample);
