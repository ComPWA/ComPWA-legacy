...
<Intensity Class='IncoherentIntensity' Name="jpsiGammaPiPi_inc">
  <Intensity Class='CoherentIntensity' Name="jpsiGammaPiPi">
    <Amplitude Class="CoefficientAmplitude" Name="f2(1270)_coeff">
      ...
      <Amplitude Class="SequentialAmplitude" Name="f2(1270)">
    ...
    <Amplitude Class="SequentialAmplitude" Name="myAmp">
...
int main(int argc, char **argv) {
  ...
  //---------------------------------------------------
  auto gen =
      std::make_shared<ComPWA::Tools::RootGenerator>(partL, kin->get, 173);
  ...
  intens->addResonances(Intensity);
