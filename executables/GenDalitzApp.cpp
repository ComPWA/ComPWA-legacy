...
int main(int argc, char **argv) {
	...
	Logging log("log", boost::log::trivial::debug); //initialize logging //setting log level
...
//	const Double_t PI = 3.14159; // m/s
	...
	std::string resoFile = path + "/executables/Examples/DalitzFit/Jake_ypipi.xml";
	...
	//Output File setup
	boost::filesystem::path output_file("/executables/Examples/DalitzFit/"+output_filename);
	string output_file_path = output_directory + "/executables/Examples/DalitzFit/" + output_filename;
