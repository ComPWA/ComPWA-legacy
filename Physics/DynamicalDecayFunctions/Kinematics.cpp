...
std::complex<double> Kinematics::widthToCoupling(double mSq, double mR, double width,
...
std::complex<double> Kinematics::couplingToWidth(double mSq, double mR, double g,
		double ma, double mb, double spin, double mesonRadius)
{
