...
namespace ComPWA { namespace Physics { namespace AmplitudeSum {
    ...
    _phase(phase), _mass(mass),
    _normStyle(nS), _ffType(type), _mesonRadius(mesonR), _motherRadius(motherR),
    ...
    _name(name), _modified(1), _nCalls(nCalls),_prefactor(1,0),
    _nameMother(mother), _name1(particleA), _name2(particleB),_mag(mag),
    _phase(phase), _mass(mass), _normStyle(nS),
    _ffType(type), _mesonRadius(std::make_shared<DoubleParameter>(name, 1.0)),
