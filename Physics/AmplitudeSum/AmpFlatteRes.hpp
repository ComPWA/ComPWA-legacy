...
public:
  ...
  AmpFlatteRes(const char *name, unsigned int varIdA, unsigned int varIdB,
               std::shared_ptr<DoubleParameter> mag,
               std::shared_ptr<DoubleParameter> phase,
               std::shared_ptr<DoubleParameter> mass, Spin spin, Spin m, Spin n,
               int P, int C, std::string mother, std::string particleA,
               std::string particleB,
               std::shared_ptr<DoubleParameter> mesonRadius,
               std::shared_ptr<DoubleParameter> motherRadius,
               std::shared_ptr<DoubleParameter> g1,
               std::shared_ptr<DoubleParameter> g2, std::string g2_idA,
               std::string g2_idB, std::shared_ptr<DoubleParameter> g3,
               std::string g3_idA, std::string g3_idB,
  ...
  virtual double GetWidth() const {
    return std::abs(couplingToWidth(
        _mass->GetValue(), _mass->GetValue(), _g1->GetValue(), _mass1, _mass2,
