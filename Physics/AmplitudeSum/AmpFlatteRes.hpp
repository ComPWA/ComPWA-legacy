...
namespace ComPWA { namespace Physics { namespace AmplitudeSum {
    ...
    public:
        ...
        AmpFlatteRes(const char *name,
                     ...
                     std::string g2_idB,
                     std::shared_ptr<DoubleParameter> g3, std::string g3_idA,
                     std::string g3_idB,
        ...
        dynamicalFunction(double mSq, double mR,
        ...
        SetupTree( ParameterList& sample, ParameterList& toySample,
                  std::string suffix);
