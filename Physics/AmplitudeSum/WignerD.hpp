...
#define MIN(x,y) (x<y ? x : y)
    ...
    double Clebsch(const Spin &__j1,const Spin &__m1,const Spin &__j2,
        ...
        return Clebsch((double)__j1,(double)__m1,(double)__j2,(double)__m2,(double)__J,(double)__M);
    }
     ...
     */
    double Wigner_d(const double _J,const double _M,const double _N , double _beta){
    ...
    inline complex<double> Wigner_D(double __alpha,double __beta,double __gamma,
                                    const double __j,const double __m,const double __n){
    ...
    inline complex<double> Wigner_D(double __alpha, double __beta, double __gamma,
        ...
        return Wigner_D(__alpha, __beta, __gamma, (double)__j, (double)__m, (double)__n);
    }
    //_____________________________________________________________________________
    ...
    void Wigner_d(const Spin &__jmax,double __beta,
        ...
        if(__jmax.GetDenominator() == 1){ // integral spins
            ...
            __d[one_half][(-1)*(int)one_half][(-1)*(int)one_half] = cos(__beta/2.);
                ...
                for(Spin n = j*(-1); n <= j; n++){
                    ...
                    for(Spin mm = -1; mm <= Spin(1); mm++){
                        for(Spin nn = -1; nn <= Spin(1); nn++){
                            djmn += Clebsch((double)j-1,(double)(m-mm),1,(double)mm,(double)j,(double)m)
                            *Clebsch((double)j-1,(double)(n-nn),1,(double)nn,(double)j,(double)n)
    ...
    void Wigner_D(const Spin &__jmax,double __alpha,double __beta,double __gamma,
        ...
        for(Spin j = jmin; j <= __jmax; j++){
            for(Spin m = j*(-1); m <= j; m++){
                for(Spin n = j*(-1); n <= j; n++)
                    __D[j][m][n] = exp(-i*((double)m*__alpha + (double)n*__gamma))*d[j][m][n];
            }
        }
    }
