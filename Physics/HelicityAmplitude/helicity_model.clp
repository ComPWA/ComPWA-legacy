...
;	then
;	  ;(printout t "decay charge conservation!" crfl)
;	  (retract ?decay)
;	)
;)
...
;	(declare (salience 99))
;	?mymother <- (SpinWave (parity ?parity_mother))
;	?mydaughter1 <- (SpinWave (parity ?parity_daughter1))
;	?mydaughter2 <- (SpinWave (parity ?parity_daughter2))
;	?decay <- (TwoBodyDecay (mother ?mymother) (daughter1 ?mydaughter1) (daughter2 ?mydaughter2))
;	=>
;	(if (<> ?parity_mother (* ?parity_daughter1 ?parity_daughter2))
;	then
;	  ;(printout t "decay violates parity!" crfl)
;	  (retract ?decay)
;	)
;)
...
;	(declare (salience 99))
;	?mymother <- (SpinWave (cparity ?cparity_mother) (charge ?charge_mother))
;	?mydaughter1 <- (SpinWave (cparity ?cparity_daughter1) (charge ?charge_daughter1))
;	?mydaughter2 <- (SpinWave (cparity ?cparity_daughter2) (charge ?charge_daughter2))
;	?decay <- (TwoBodyDecay (mother ?mymother) (daughter1 ?mydaughter1) (daughter2 ?mydaughter2))
;	=>
