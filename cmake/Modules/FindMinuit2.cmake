...
IF( NOT Minuit2_FIND_QUIETLY )
	IF( Minuit2_FOUND )
		MESSAGE(STATUS "Minuit2 include dir: " ${MINUIT2_INCLUDE_DIR})
		MESSAGE(STATUS "Minuit2 library dir: " ${MINUIT2_LIBRARY_DIR})
		MESSAGE(STATUS "Minuit2 library: " ${MINUIT2_LIBRARIES})
	ELSE()
