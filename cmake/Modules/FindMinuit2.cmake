...
GET_FILENAME_COMPONENT( MINUIT2_LIBRARY_DIR ${MINUIT2_LIBRARIES} DIRECTORY )

SET(MINUIT2_VERSION_STRING "0.0")

MESSAGE(STATUS "Searching for Minuit2" ${MINUIT2_LIBRARIES} ${MINUIT2_INCLUDE_DIR} ${VERSION_VAR} ${MINUIT2_VERSION_STRING})
  
# Sets Minuit2_FOUND to true if all variabels are defined
FIND_PACKAGE_HANDLE_STANDARD_ARGS(Minuit2 REQUIRED_VARS
	MINUIT2_LIBRARIES MINUIT2_INCLUDE_DIR VERSION_VAR MINUIT2_VERSION_STRING)

# Report some results
IF( NOT Minuit2_FIND_QUIETLY )
	IF( DEFINED Minuit2_FOUND )
		MESSAGE(STATUS "FindMinuit2: include dir: " ${MINUIT2_INCLUDE_DIR})
		MESSAGE(STATUS "FindMinuit2: library dir: " ${MINUIT2_LIBRARY_DIR})
		MESSAGE(STATUS "FindMinuit2: library: " ${MINUIT2_LIBRARIES})
	ELSE()
		MESSAGE(STATUS "FindMinuit2: Minuit2 installation could not be found!")
	ENDIF()
ENDIF()
