...
public:
  ...
  inline void SetImag(double Imag);
...
EvtComplex conj(const EvtComplex &c) { return EvtComplex(c._rpart, -c._ipart); }
...
double real(const EvtComplex &c) { return c._rpart; }

double imag(const EvtComplex &c) { return c._ipart; }

void EvtComplex::SetReal(double Real) { _rpart = Real; }
void EvtComplex::SetImag(double Imag) { _ipart = Imag; }
