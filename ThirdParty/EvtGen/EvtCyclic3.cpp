...
Pair EvtCyclic3::combine(Index i, Index j) { return other(other(i, j)); }
...
Pair EvtCyclic3::other(Pair i, Pair j) { return combine(other(i), other(j)); }
...
Index EvtCyclic3::common(Pair i, Pair j) { return other(other(i, j)); }
