...
class EvtVector4C {
  ...
  friend EvtVector4C rotateEuler(const EvtVector4C &e, double alpha,
                                 double beta, double gamma);
  friend EvtVector4C boostTo(const EvtVector4C &e, const EvtVector4R p4);
  friend EvtVector4C boostTo(const EvtVector4C &e, const EvtVector3R boost);
...
inline void EvtVector4C::set(int i, const EvtComplex &c) { v[i] = c; }
...
inline const EvtComplex &EvtVector4C::get(int i) const { return v[i]; }
...
inline EvtVector4C EvtVector4C::conj() const {
  ...
  return EvtVector4C(::conj(v[0]), ::conj(v[1]), ::conj(v[2]), ::conj(v[3]));
}
