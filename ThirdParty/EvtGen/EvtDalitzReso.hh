...
#include "EvtGen/EvtDalitzPoint.hh"
#include "EvtGen/EvtSpinType.hh"
#include "EvtGen/EvtTwoBodyVertex.hh"
// #include "EvtGen/EvtDecayAmp.hh"
#include "EvtGen/EvtBlattWeisskopf.hh"
#include "EvtGen/EvtFlatte.hh"
...
public:
  ...
  // K-matrix
  EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                EvtCyclic3::Pair pairRes, std::string nameIndex, NumType typeN,
                EvtComplex fr12prod, EvtComplex fr13prod, EvtComplex fr14prod,
  ...
  // LASS
  EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                EvtCyclic3::Pair pairRes, double m0, double g0, double a,
                double r, double B, double phiB, double R, double phiR);
  ...
  //   std::cout<<"Spin: "<<EvtSpinType::getSpin2(_spin)
  //   <<std::endl; std::cout<<"Type: "<<_typeN			<<std::endl;
  //   }
  //
  ...
  EvtComplex evaluateLASS(const EvtDalitzPoint &x,
