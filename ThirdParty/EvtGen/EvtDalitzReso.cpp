...
#include "EvtGen/EvtMatrix.hh"
#include "EvtGen/EvtReport.hh"

#include "EvtGen/EvtCyclic3.hh"
...
// single Breit-Wigner
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             Pair pairAng, Pair pairRes,
                             EvtSpinType::spintype spin, double m0, double g0,
                             NumType typeN, double f_b, double f_d)
    : _Name(name), _dp(dp), _pairAng(pairAng), _pairRes(pairRes), _spin(spin),
      _typeN(typeN), _m0(m0), _g0(g0), _massFirst(dp.m(first(pairRes))),
      _massSecond(dp.m(second(pairRes))), _m0_mix(-1.), _g0_mix(0.),
      _delta_mix(0.), _amp_mix(0., 0.), _g1(-1.), _g2(-1.),
      _coupling2(Undefined), _f_b(f_b), _f_d(f_d), _kmatrix_index(-1),
      _fr12prod(0., 0.), _fr13prod(0., 0.), _fr14prod(0., 0.),
      _fr15prod(0., 0.), _s0prod(0.), _a(0.), _r(0.), _Blass(0.), _phiB(0.),
      _R(0.), _phiR(0.) {
  _vb = EvtTwoBodyVertex(_m0, _dp.m(EvtCyclic3::other(_pairRes)), _dp.bigM(),
                         _spin);
  _vd = EvtTwoBodyVertex(_massFirst, _massSecond, _m0, _spin);
  _vb.set_f(
      _f_b); // Default values for Blatt-Weisskopf factors are 0.0 and 1.5.
  _vd.set_f(_f_d);
...
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
    ...
    : _Name(name), _dp(dp), _pairAng(pairAng), _pairRes(pairRes), _spin(spin),
      _typeN(typeN), _m0(m0), _g0(g0), _massFirst(dp.m(first(pairRes))),
      _massSecond(dp.m(second(pairRes))), _m0_mix(m0_mix), _g0_mix(g0_mix),
      _delta_mix(delta_mix), _amp_mix(amp_mix), _g1(-1.), _g2(-1.),
      _coupling2(Undefined), _f_b(0.0), _f_d(1.5), _kmatrix_index(-1),
      _fr12prod(0., 0.), _fr13prod(0., 0.), _fr14prod(0., 0.),
      _fr15prod(0., 0.), _s0prod(0.), _a(0.), _r(0.), _Blass(0.), _phiB(0.),
      _R(0.), _phiR(0.) {
  _vb = EvtTwoBodyVertex(_m0, _dp.m(EvtCyclic3::other(_pairRes)), _dp.bigM(),
...
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             Pair pairAng, Pair pairRes,
                             EvtSpinType::spintype spin, double m0,
                             NumType typeN, double g1, double g2,
                             CouplingType coupling2)
    : _Name(name), _dp(dp), _pairAng(pairAng), _pairRes(pairRes), _spin(spin),
      _typeN(typeN), _m0(m0), _g0(-1.), _massFirst(dp.m(first(pairRes))),
      _massSecond(dp.m(second(pairRes))), _m0_mix(-1.), _g0_mix(0.),
      _delta_mix(0.), _amp_mix(0., 0.), _g1(g1), _g2(g2), _coupling2(coupling2),
      _f_b(0.0), _f_d(1.5), _kmatrix_index(-1), _fr12prod(0., 0.),
      _fr13prod(0., 0.), _fr14prod(0., 0.), _fr15prod(0., 0.), _s0prod(0.),
...
// K-Matrix (A&S)
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             Pair pairRes, std::string nameIndex, NumType typeN,
                             EvtComplex fr12prod, EvtComplex fr13prod,
                             EvtComplex fr14prod, EvtComplex fr15prod,
                             double s0prod)
    : _Name(name), _dp(dp), _pairRes(pairRes), _typeN(typeN), _m0(0.), _g0(0.),
      _massFirst(dp.m(first(pairRes))), _massSecond(dp.m(second(pairRes))),
      _m0_mix(-1.), _g0_mix(0.), _delta_mix(0.), _amp_mix(0., 0.), _g1(-1.),
      _g2(-1.), _coupling2(Undefined), _f_b(0.), _f_d(0.), _kmatrix_index(-1),
      _fr12prod(fr12prod), _fr13prod(fr13prod), _fr14prod(fr14prod),
      _fr15prod(fr15prod), _s0prod(s0prod), _a(0.), _r(0.), _Blass(0.),
      _phiB(0.), _R(0.), _phiR(0.) {
  assert(_typeN == K_MATRIX || _typeN == K_MATRIX_I || _typeN == K_MATRIX_II);
...
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             NumType typeN)
    : _Name(name), _dp(dp), _pairRes(EvtCyclic3::BC), _typeN(typeN), _m0(0.),
      _g0(0.), _massFirst(dp.m(first(EvtCyclic3::BC))),
      _massSecond(dp.m(second(EvtCyclic3::BC))), _m0_mix(-1.), _g0_mix(0.),
      _delta_mix(0.), _amp_mix(0., 0.), _g1(-1.), _g2(-1.),
      _coupling2(Undefined), _f_b(0.), _f_d(0.), _kmatrix_index(-1), _a(0.),
      _r(0.), _Blass(0.), _phiB(0.), _R(0.), _phiR(0.) {
  assert(_typeN == K_MATRIX || _typeN == K_MATRIX_I || _typeN == K_MATRIX_II);
  _spin = EvtSpinType::SCALAR;
}
...
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             Pair pairRes, double m0, double g0, double a,
                             double r, double B, double phiB, double R,
                             double phiR)
    : _Name(name), _dp(dp), _pairRes(pairRes), _typeN(LASS), _m0(m0), _g0(g0),
      _massFirst(dp.m(first(pairRes))), _massSecond(dp.m(second(pairRes))),
      _m0_mix(-1.), _g0_mix(0.), _delta_mix(0.), _amp_mix(0., 0.), _g1(-1.),
      _g2(-1.), _coupling2(Undefined), _f_b(0.0), _f_d(1.5), _kmatrix_index(-1),
      _fr12prod(0., 0.), _fr13prod(0., 0.), _fr14prod(0., 0.),
      _fr15prod(0., 0.), _s0prod(0.), _a(a), _r(r), _Blass(B), _phiB(phiB),
      _R(R), _phiR(phiR) {
  _spin = EvtSpinType::SCALAR;
  _vd = EvtTwoBodyVertex(_massFirst, _massSecond, _m0, _spin);
...
// Flatte
EvtDalitzReso::EvtDalitzReso(std::string name, const EvtDalitzPlot &dp,
                             EvtCyclic3::Pair pairRes, double m0)
    : _Name(name), _dp(dp), _pairRes(pairRes), _typeN(FLATTE), _m0(m0), _g0(0.),
      _massFirst(dp.m(first(pairRes))), _massSecond(dp.m(second(pairRes))),
      _m0_mix(-1.), _g0_mix(0.), _delta_mix(0.), _amp_mix(0., 0.), _g1(-1.),
      _g2(-1.), _coupling2(Undefined), _f_b(0.), _f_d(0.), _kmatrix_index(-1),
      _fr12prod(0., 0.), _fr13prod(0., 0.), _fr14prod(0., 0.),
...
EvtDalitzReso::EvtDalitzReso(const EvtDalitzReso &other)
    : _Name(other._Name), _dp(other._dp), _pairAng(other._pairAng),
      _pairRes(other._pairRes), _spin(other._spin), _typeN(other._typeN),
      _m0(other._m0), _g0(other._g0), _vb(other._vb), _vd(other._vd),
      _massFirst(other._massFirst), _massSecond(other._massSecond),
      _m0_mix(other._m0_mix), _g0_mix(other._g0_mix),
      _delta_mix(other._delta_mix), _amp_mix(other._amp_mix), _g1(other._g1),
      _g2(other._g2), _coupling2(other._coupling2), _f_b(other._f_b),
      _f_d(other._f_d), _kmatrix_index(other._kmatrix_index),
      _fr12prod(other._fr12prod), _fr13prod(other._fr13prod),
      _fr14prod(other._fr14prod), _fr15prod(other._fr15prod),
      _s0prod(other._s0prod), _a(other._a), _r(other._r), _Blass(other._Blass),
      _phiB(other._phiB), _R(other._R), _phiR(other._phiR),
      _flatteParams(other._flatteParams) {}

EvtDalitzReso::~EvtDalitzReso() {}

// Set LASS Parameters
void EvtDalitzReso::set_a(double a) { _a = a; }
void EvtDalitzReso::set_r(double r) { _r = r; }
void EvtDalitzReso::set_B(double B) { _Blass = B; }
void EvtDalitzReso::set_phiB(double phiB) { _phiB = phiB; }
void EvtDalitzReso::set_R(double Rneu) { _R = Rneu; }
void EvtDalitzReso::set_phiR(double phiR) { _phiR = phiR; }
...
EvtComplex EvtDalitzReso::evaluate(const EvtDalitzPoint &x) {
  ...
  if (fabs(_dp.bigM() - x.bigM()) > 0.000001) {
    _vb = EvtTwoBodyVertex(_m0, _dp.m(EvtCyclic3::other(_pairRes)), x.bigM(),
                           _spin);
    _vb.set_f(_f_b);
  }
  ...
  if (_typeN == NBW) {
    ...
    if (_coupling2 == Undefined) {
      ...
      case PicPic: {
        ...
        double mPic = 1.3957018e-01;
        G2 = _g2 * _g2 * psFactor(mPic, mPic, m);
        break;
      }
      case PizPiz: {
        G1 = _g1 * _g1 * psFactor(_massFirst, _massSecond, m);
        double mPiz = 1.3497660e-01;
      ...
      case KcKc: {
        G1 = _g1 * _g1 * psFactor(_massFirst, _massSecond, m);
        double mKc = 4.9367700e-01;
        G2 = _g2 * _g2 * psFactor(mKc, mKc, m);
        break;
      }
      case KzKz: {
        G1 = _g1 * _g1 * psFactor(_massFirst, _massSecond, m);
        double mKz = 4.9761400e-01;
      ...
      default:
        std::cout << "EvtDalitzReso:evaluate(): PANIC, wrong coupling2 state."
                  << std::endl;
        assert(0);
        break;
      }
...
EvtComplex EvtDalitzReso::propGounarisSakurai(const double &m0,
                                              ...
                                              const double &g,
                                              const double &k) {
  // Gounaris-Sakurai parameterization of pi+pi- P wave. PRD, Vol61, 112002.
  // PRL, Vol21, 244. Expressions taken from BAD637v4, after fixing the
  // imaginary part of the BW denominator: i M_R Gamma_R(s) --> i sqrt(s)
  // Gamma_R(s)
...
EvtComplex EvtDalitzReso::numerator(const EvtDalitzPoint &x,
  ...
  // CLEO amplitude
    ...
    // std::cout<<"mB: "<<mB<<endl;
    // std::cout<<"mC: "<<mC<<endl;
    // std::cout<<"qAB: "<<qAB<<endl;
    // std::cout<<"qBC: "<<qBC<<endl;
    // std::cout<<"qCA: "<<qCA<<endl;
    // std::cout<<"---------------------------------"<<endl;
...
EvtComplex EvtDalitzReso::Fvector(double s, int index) {
  ...
  double g[5][5]; // Coupling constants. The first index is the pole index. The
                  // second index is the decay channel
  ...
  if (solution == 0) {
    std::cout << "EvtDalitzReso::Fvector() error. Kmatrix solution incorrectly "
                 "chosen ! "
              << std::endl;
    abort();
  }
  ...
  if (index <= 5) {
    ...
    // std::cout<<"------------------------"<<std::endl;
    //     std::cout<<"U1j[0]: "<<U1j[0]<<std::endl;
    //     std::cout<<"U1j[1]: "<<U1j[1]<<std::endl;
    //     std::cout<<"U1j[2]: "<<U1j[2]<<std::endl;
    //     std::cout<<"U1j[3]: "<<U1j[3]<<std::endl;
    //     std::cout<<"U1j[4]: "<<U1j[4]<<std::endl;
...
EvtComplex EvtDalitzReso::CalcdeltaR(const EvtDalitzPoint &x) {

  double m2 = x.q(_pairRes);
  EvtTwoBodyKine vd(_massFirst, _massSecond, sqrt(m2));
  double q = vd.p();

  double GammaM = _g0 * _vd.widthFactor(vd); // running width;
  double deltaR = atan((_m0 * GammaM / (_m0 * _m0 - m2)));

  return EvtComplex(deltaR, q);
}

EvtComplex EvtDalitzReso::evaluateLASS(const EvtDalitzPoint &x,
                                       const EvtComplex &deltaR_comp) {

  if (!(x.isValid())) {
    return EvtComplex(0., 0.);
  }

  double q = imag(deltaR_comp);
  ...
  // calculate the resonant phase motion
  double deltaR = real(deltaR_comp);
  double totalR = deltaR + _phiR;
...
vector<EvtComplex> EvtDalitzReso::evaluateKMat(double s) {

  //   double s = x.q(_pairRes);
  // Define the complex coupling constant
  // The convection is as follow
  // i=0 --> pi+ pi-
  // i=1 --> KK
  ...
  EvtMatrix<EvtComplex> *matInverse =
      mat.inverse(); // The 1st row of the inverse matrix. This matrix is
                     // {(I-iKp)^-1}_0j
  vector<EvtComplex> U1j;
  vector<EvtComplex> BackVec;
  for (int j = 0; j < 5; j++) {
    U1j.push_back((*matInverse)[0][j]);
    BackVec.push_back((*matInverse)[0][j]);
    BackVec[j] *= SmallTerm;
  }

  //   for ( int j = 0; j < 5; j++ )
  //   {
  //   BackVec.push_back( K[ j ][ 0 ]);
  //   }

  for (int i2 = 0; i2 < 5; i2++) {
    EvtComplex Cmplx_tmp(0, 0);
    for (int j = 0; j < 5; j++) { // sum for 5 channel
      EvtComplex top = U1j[j] * g[i2][j];
      double bottom = ma[i2] * ma[i2] - s;

      if (fabs(bottom) < PRECISION) {
        Cmplx_tmp += top;
      } else {
        Cmplx_tmp += top / bottom * SmallTerm;
      }
    }
    BackVec.push_back(Cmplx_tmp);
  }
  delete matInverse;
...
EvtComplex EvtDalitzReso::CalcGounarisSakurai(double m) {
...
vector<EvtComplex> EvtDalitzReso::evaluateTOneOne(double s) {
  ...
  for (int i2 = 0; i2 < 5; i2++) {
    ...
    //
    //     }
    BackVec.push_back(K[0][i2] * SmallTerm);
  }
  delete matInverse;
