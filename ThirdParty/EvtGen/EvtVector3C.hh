...
class EvtVector3C {
  ...
  friend EvtVector3C rotateEuler(const EvtVector3C &v, double phi, double theta,
                                 double ksi);
...
inline void EvtVector3C::set(const int i, const EvtComplex &c) { v[i] = c; }
...
inline const EvtComplex &EvtVector3C::get(int i) const { return v[i]; }
