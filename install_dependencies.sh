...
wget ftp://root.cern.ch/root/root_v5.34.23.source.tar.gz
...
wget http://www-meg.phys.cmu.edu/williams/qft++/qft++.v1.tar.gz

tar xf qft++.v1.tar.gz

cd qft++/src
wget --no-check-certificate https://raw.githubusercontent.com/ComPWA/ComPWA/gh-pages/patches/qft++.patch
patch -p0 < qft++.patch
rm qft++.patch
make
